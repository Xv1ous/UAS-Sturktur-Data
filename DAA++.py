...
def menu(biodata):
    while True:
        ...
        print("2. Hapus jadwal booking")
        print("3. Jadwal yang sudah di booking")
        ...
        if pilihan_menu == 1:
            ...
            # menu 3 - hapus jadwal
            hapus_biodata(biodata)
            
            # kembali k menu utama
            input("Tekan Enter untuk kembali ke menu utama.")  
...
def hapus_biodata(biodata):
    nim = input("Masukkan NIM untuk menghapus entri: ")
    if nim in biodata:
        del biodata[nim]
        print("Entri dengan NIM", nim, "telah dihapus.")
    else:
        print("Entri dengan NIM", nim, "tidak ditemukan.")
